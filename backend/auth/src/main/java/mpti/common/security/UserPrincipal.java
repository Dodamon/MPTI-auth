...
public class UserPrincipal implements OAuth2User, UserDetails {
    ...
    private UserPrincipal(Long id, String name, String email, String password, Map<String, Object> attributes, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
        this.name = name;
        this.email = email;
...
//        );
        ...
        attributes.put("needUpdate", user.getNeedUpdate());
        attributes.put("stopUntil", user.getStopUntil());
